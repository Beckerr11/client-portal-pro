...
const projectProfile = {
  ...
  "tagline": "Portal operacional para acompanhamento transparente de projetos.",
  "vertical": "client-success",
  "entity": {
    "singular": "demanda",
    "plural": "demandas"
  },
  "copy": {
    "titleLabel": "Titulo da demanda",
    "detailsLabel": "Contexto para o cliente",
    "createButton": "Criar demanda",
    "workspaceTitle": "Painel de demandas e entregas",
    "workspaceDescription": "Mantenha visibilidade completa para cliente e equipe em um unico fluxo."
  },
  "mvp": [
    "Timeline de entregas com status e dono responsavel.",
    "Central de demandas com prioridade e contexto de negocio.",
    "Painel de andamento para reuniao com cliente.",
    "Fluxo de aprovacao para cada entrega planejada."
  ],
  "workflow": [
    "Registrar demanda com escopo e criterio de aceite.",
    "Priorizar etapa atual e atualizar andamento semanal.",
    "Concluir entrega e enviar para aprovacao do cliente."
  ],
  "seedItems": [
    {
      "title": "Publicar pagina de servicos no portal",
      "details": "Subir versao final com seo basico, FAQ e bloco de cases aprovados.",
      "priority": "high",
      "status": "open"
    },
    {
      "title": "Revisar area de documentos",
      "details": "Adicionar filtro por categoria e data de ultima atualizacao.",
      "priority": "medium",
      "status": "open"
    },
    {
      "title": "Ajustar status de marcos atrasados",
      "details": "Atualizar regra para destacar marcos com vencimento em atraso.",
      "priority": "low",
      "status": "done"
    }
  ]
